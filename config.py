...
tree = Map({
	'menu': {
		'text': 'Привет!😀 Только у нас получают подарки 🎁 играя в любимые игры! 🎮',
		'buttons': [
			[
				{
	...
	'list_games': {
		'messages': [
			...
			},
			{
				...
				'text': 'Дровосек против полчища деревьев 🌲 и веток! Наруби 500 деревьев и забирай ПОДАРОК! 🎁',
	...
	'сonditions': {
		'image': Image.open('./images/primotka_together.png'),
		'text': 'Для получения подарка вам нужно :\n\n1. Купить игрушку в магазинах наших партнеров со стикером "ПОДАРОК!"\n2. Сохранить чек подтвердающий покупку игрушки\n3. Набрать нужное кол-во очков для получения ПОДАРКА\n',
		'buttons': [
			[
				{
	...
	'list_partners': {
		'text': 'СПИСОК ПАРТНЕРОВ\n\n1. Сеть супермаркетов "Small"\n2. Сеть магазинов у дома "Daily market"\n3. Сеть АЗС "Compass"',
		'buttons': [
			[
				{
					'text': 'Назад 🏘',
